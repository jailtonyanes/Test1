...
function loguear_empleado()
{
     var form= $("#login").serialize();
  			   $.post('_admin/gurado_logs.php',form,
				function(data)
				{
  		             alert(data);
					if(jQuery.trim(data)=='Ingreso a la empresa' || jQuery.trim(data)=='Salida a almorzar' || jQuery.trim(data)=='Regreso del almuerzo' || jQuery.trim(data)=='Fin de jornada laboral'  )
					{
