...
<script type="text/javascript" src="../_javascript/contenedor.js"></script>
...
?>
  <h2>Estado de Cuenta Por Contenedor </h2>
  <form id="view_est" name="view_est" method="post" action="">
  </form>
  <div id="detalle_contenedor" style="display:none"> </div>
</div>
</body>
</html>