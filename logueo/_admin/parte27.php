...
<input type="hidden" name="docu" id="docu" />
  <table width="800" border="0" id="datos_cli" cellpadding="0" cellspacing="0" style="margin:5px auto">
    <?php
			  $query="SELECT * FROM preguntas WHERE encuesta_id =7 AND pertenece_a = 'MR1'";
  ...
  if($result)
   {
    ...
    <tr><td colspan="2"><label>Porque:</label><input name="pq" type="text" id="pq" size="144" value="N/A" /></td></tr>
    <?php
		   $i++;
		 }
		 ?>
