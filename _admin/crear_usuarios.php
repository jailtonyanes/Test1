...
<div id="container">
  <?php 
    ...
    ?>
  <div id="content">  
  <h2 class="datos_cli">Crear Usuario</h2>
...
<p>
    <label> Apellido:
      <input name="apellido" id="apellido" type="text" class="ancho">
      </input>
    </label>
  ...
  <p>
    <label> Password:
      <input name="password" id="password" type="password" class="ancho">
      </input>
    </label>
  ...
  <p>
    <label> Nick:
      <input name="nick" id="nick" type="text" class="ancho">
      </input>
    </label>
  ...
  <p>
    <label>
     Tipo de usuario
      ...
      <select name="tipo_usuario" id="tipo_usuario" class="ancho">
    ...
    <label>
     Estado Usuario
      ...
      <select name="estado_usuario" id="estado_usuario" class="ancho">
     ...
     <input type="submit" name="guardar" id="guardar" value="Guardar Usuario" style="   margin-bottom: 15px;
    margin-left: 217px;">
      </form>
      </div>
 </div>    
