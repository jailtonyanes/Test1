...
<script type="text/javascript" src="../_javascript/minimo.js"></script>
...
<title>Tope de salario mínimo </title>
<!-- Calendario !-->
...
<div id="container">
  <?php 
    ...
    ?>
  <div id="content">  
  <h2 class="datos_cli">Fijar el tope del salario mínimo</h2>
 ...
 <label>Año:</label> 
  ...
  <p>
    <label> Fijar monto:
      <input name="monto" id="monto" type="text" class="ancho" onKeyPress="return validarnum(event)">
      </input>
    </label>
     ...
     <input type="submit" name="guardar" id="guardar" value="Guardar Monto" style="margin-bottom: 15px;
    margin-left: 217px;">
      </form>
      </div>
