...
<div id="container">
  <?php 
    ...
    ?>
  <div id="content">  
  <h2 class="datos_cli">Crear Turnos</h2>
  ...
  <p>
    <label> Nombre:
      <input name="nombre" id="nombre" type="text" class="ancho">
      </input>
    </label>
...
<p>
 ...
 <p>
    <label> D&iacute;as de trabajo diurno:
      <input name="dtd" id="dtd" type="text" value="0"  class="ancho" onKeyUp="javascript:sumar()" onKeyPress="return validarnum(event)">
      </input>
    </label>
  ...
  <p style="padding-right:140px;">
    <label> Rango:
      <input name="inidia" id="inidia" type="text" class="anhora" >
      </input>
      <input name="findia" id="findia" type="text" class="anhora" >
      </input>
    </label>
  ...
  <p>
    <label> D&iacute;as de trabajo nocturno:
      <input name="dtn" id="dtn" type="text" value="0" class="ancho" onKeyUp="javascript:sumar()" onKeyPress="return validarnum(event)">
      </input>
    </label>
...
<p style="padding-right:140px;">
    <label> Rango:
      <input name="ininoche" id="ininoche" type="text" class="anhora" >
      </input>
      <input name="finnoche" id="finnoche" type="text" class="anhora" >
      </input>
    </label>
  ...
  <p>
    <label> D&iacute;as de descanso:
      <input name="dd" id="dd" type="text" value="0" class="ancho" onKeyPress="return validarnum(event)">
      </input>
    </label>
  ...
  <p >
    <label> D&iacute;as laborados:
      <input name="dl" id="dl" type="text" class="ancho" readonly="readonly">
      </input>
    </label>
   ...
   <p>
    ...
    <label> Tipo de jornada:
     ...
     <input type="submit" name="guardar" id="guardar" value="Guardar Turno" style="   margin-bottom: 15px;
    margin-left: 217px;">
      </form>
      </div>
 </div>    
