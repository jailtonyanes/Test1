...
<script type="text/javascript" src="../_javascript/c_sucursal.js"></script>
...
<div id="container">
  <?php 
    ...
    ?>
  <div id="content">  
  <h2 class="datos_cli">Crear Sucursal</h2>
...
<!--                                                                MUNICIPIO -->
 ...
 <p>
  ...
  <p>
    ...
    <p>
    <label> Contacto:
      <input name="suc_contacto" id="suc_contacto" type="text" class="ancho">
      </input>
    </label>
  ...
  <label> E-mail Contacto:
      <input name="email_contacto" id="email_contacto" type="text" class="ancho">
      </input>
    </label>
  ...
  <label> Tel&eacute;fono Contacto:
      <input name="tel_contacto" id="tel_contacto" type="text" class="ancho">
      </input>
    </label>
     ...
     <input type="submit" name="save_suc" id="save_suc" value="Guardar Sucursal" style="margin-bottom: 15px;
    margin-left: 217px;">
      </form>
      </div>
 </div>    
