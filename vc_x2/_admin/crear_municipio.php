...
<script type="text/javascript" src="../_javascript/municipio.js"></script>
...
<div id="container">
  <?php 
    ...
    ?>
  <div id="content">  
  <h2 class="datos_cli">Crear Municipio</h2>
...
?>
  ...
  <p>
    <label> Nombre:
     ...
     <input type="submit" name="guardar" id="guardar" value="Guardar Municipio" style="   margin-bottom: 15px;
    margin-left: 217px;">
      </form>
      </div>
 </div>    
