...
?>
  ...
  <?php
   ...
   $crud->setConsulta("SELECT municipio_nombre, municipio.departamento_id FROM municipio WHERE 
municipio_id='$_GET[uid]'");
...
<p>
  ...
  <?php
   ...
   $crud2->setConsulta("select departamento_id,departamento_nombre from departamento order by departamento_nombre asc");

   $datos = $crud2->seleccionar($con->getConection());

   $i=0;
   while ($i<sizeof($datos))
   {   
?>
   <option value="<?php echo $datos[$i]['departamento_id'] ?>" <?php  if($datos1[0]['departamento_id']==$datos[$i]['departamento_id']){echo "selected=selected";} ?>   ><?php echo $datos[$i]['departamento_nombre'] ?></option>
...
?>
  ...
  <p>
    <label> Nombre:
      <input name="nombre" id="nombre" type="text" class="ancho" value="<?php echo $datos1[0]['municipio_nombre'] ?>">
      </input>
    </label>
