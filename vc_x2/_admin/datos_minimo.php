...
?>
  ...
  <?php
   ...
   $crud->setConsulta("SELECT * FROM minimo WHERE minimo_id='$_GET[uid]'");
...
$i=0;
 ...
 <p style="padding-right:166px">
 <label>Año:</label> 
    <select id="year" name="year" class="select_search">
       <option value="" selected="selected"> Escoja opci&oacute;n</option>
        <?php
         ...
         {
         ?>
           <option <?php if($datos1[0]['fecha']==$i){echo "selected='selected'";} ?> value="<?php echo $i ?>" ><?php echo $i ?> </option>
         <?php	
          $i++;
         }
  ...
  <p>
    <label> Fijar monto:
      <input name="monto" id="monto" type="text" class="ancho" onKeyPress="return validarnum(event)" value="<?php echo $datos1[0]['minimo_monto']  ?>">
      </input>
    </label>
