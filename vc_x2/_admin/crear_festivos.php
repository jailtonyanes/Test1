...
<script type="text/javascript" src="../_javascript/festivos.js"></script>
...
<div id="container">
  <?php 
    ...
    ?>
  <div id="content">  
  <h2 class="datos_cli">Crear D&iacute;as Festivos</h2>
  ...
  <p>
    <label> Fecha:
      <input name="fecha" id="fecha" type="text" class="ancho" readonly="readonly">
      </input>
       <script type="text/javascript">
     ...
     <input type="submit" name="guardar" id="guardar" value="Guardar Fecha" style="margin-bottom: 15px;
    margin-left: 217px;">
      </form>
      </div>
...
<fieldset style="width:234px; margin:5px 0 0 480px; padding:10px">
 <legend>Filtro de b&uacute;squeda </legend>
    
   <label>Año:</label> 
    <select id="fecha_b" name="fecha_b" class="select_search">
    ...
    <input type="button" value="Buscar" name="search" id="search" onclick="javascript:ver_clientes()">
</fieldset>
