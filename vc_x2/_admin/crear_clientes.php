...
<script type="text/javascript" src="../_javascript/c_clientes.js"></script>
...
<div id="container">
  <?php 
    ...
    ?>
  <div id="content">  
  <h2 class="datos_cli">Crear Clientes</h2>
  ...
  <p>
    <label>Nit:
      <input name="nit" id="nit" type="text" class="ancho">
      </input>
    </label>
  ...
  <p>
    <label>Tel&eacute;fono:
      <input name="telefono" id="telefono" type="text" class="ancho">
      </input>
    </label>
  ...
  <p>
    <label>P&aacute;gina Web:
      <input name="web" id="web" type="text" class="ancho">
      </input>
    </label>
  ...
  <p>
    <label>Contacto Nombre:
      <input name="c_nombre" id="c_nombre" type="text" class="ancho">
      </input>
    </label>
  ...
  <p>
    <label>Contacto Tel&eacute;fono:
      <input name="c_telefono" id="c_telefono" type="text" class="ancho">
      </input>
    </label>
  ...
  <p>
    <label>Contacto Email:
      <input name="c_email" id="c_email" type="text" class="ancho">
      </input>
    </label>
     ...
     <input type="submit" name="save_emp" id="save_emp" value="Guardar Cliente" style="   margin-bottom: 15px;
    margin-left: 217px;">
      </form>
      </div>
 </div>    
