...
function update_departamento(){
				...
				$.post('update_festivo.php',form,
				function(data){
						alert(data);
					if(jQuery.trim(data)=='Fecha Actualizada con exito.'){
					   ver_clientes();
...
function ingresar_clientes(){
 ...
 var form= $("#sub").serialize();
  ...
  $.post('../_admin/guarda_festivos.php',form,
		...
		function(data){
				...
				alert(data);
				 ...
				 if(jQuery.trim(data)=='Fecha Ingresada Exitosamente.')

				 {
				   
				    ver_clientes();
     	            $("#guardar").val('Guardar Fecha');
...
function ver_clientes(){
 ...
 var fecha_b=$("#fecha_b").val();
  ...
  $("#search").attr('disabled', true);	
	 $("#view_cli").load("sacar_festivos.php?fecha="+fecha_b,function(){
...
function editar_cliente(user){
 ...
 $("#edit_cli").load("datos_festivo.php?uid="+$idvalor,function(){
...

{
...

	 {
		...
		if( confirm('Desea eliminar las fechas festivas seleccionadas?') )
