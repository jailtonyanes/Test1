...
function ingresar_clientes(){
 ...
 var form= $("#sub").serialize();
  ...
  $.post('../_admin/guarda_clientes.php',form,
		...
		function(data){
				...
				alert(data);
				 ...
				 if(jQuery.trim(data)=='Cliente Ingresado Exitosamente.')
...
function ver_clientes(){
 ...
 $("#view_cli").load("sacar_cliente.php",function(){
...
function modificar_clientes(){
     ...
     if($("#nit").val()=='' || $("#nombre").val()=='' || $("#direccion").val()=='' || $("#telefono").val()=='' || $("#email").val()=='' ||
     $("#c_nombre").val()=='' || $("#c_telefono").val()=='' || $("#c_email").val()==''   )
		...
		else
		{
				...
				$.post('edit_clientes_corp.php',form,
				function(data){
						alert(data);
					if(jQuery.trim(data)=='Cliente Actualizado Con Exito.'){
					   ver_clientes();
                      $("#edit_cli").fadeOut("medium");    
					}	
				},{
  ...
  // $.ajaxSettings.cache = false;
    ...
    $("#sub").validate({
		rules: {			 
                ...
                c_nombre:{required:true},
                c_telefono:{required:true},
