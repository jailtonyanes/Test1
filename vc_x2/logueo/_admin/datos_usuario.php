  ...
  $query="select * from categoria where categoria_id='$_GET[uid]'";
  ...
  <div id="datos">
   ...
   <p>
    <label>* Nombre de la categoria:
      <input type="text" name="categoria_nombre" id="categoria_nombre"  class="ancho" value="<?php echo $row['categoria_nombre'] ?>"/>
    </label>
  </p>
