...
";
 ...
 if($num_rows>0){
  ...
  <tr>
    ...
    <td align="right" class="margen_der_abj" <?php if( $i % 2 !=0){echo 'style="background-color:#F0F0F6" ';} ?>><a  style="cursor:pointer; color:#00F"onclick="javascript:ver_resultadosx(<?php echo $row['usuario_cedula'] ?>)"><?php echo $row['usuario_cedula'] ?></a></td>
...
<div id="encuestas" style="display:none">
