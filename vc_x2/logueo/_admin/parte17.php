...
<?php 
   ...
   else
    {
		   ...
		   ?>
<p align="center" style="font-size:16"><strong>Encuesta Extralaboral</strong></p>
<p align="center" style="font-size:16"><strong>Mi vida fuera del trabajo</strong></p>
...
<input type="hidden" name="docu" id="docu" />
  <table width="800" border="0" id="datos_cli" cellpadding="0" cellspacing="0" style="margin:5px auto">
    <?php
			  $query="SELECT * FROM preguntas WHERE encuesta_id =3 AND pertenece_a = 'VFTR'";
