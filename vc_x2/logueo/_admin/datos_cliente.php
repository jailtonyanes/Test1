 ...
 $query="SELECT
     subcategoria_id,categoria.categoria_nombre, subcategoria.subcategoria_nombre
,categoria.categoria_id
FROM
    ew.subcategoria
    INNER JOIN ew.categoria 
        ON (subcategoria.categoria_id = categoria.categoria_id) WHERE subcategoria_id='$_GET[uid]'";
 $result=mysql_query($query,$connection);
 if($result)
 {
  $row=mysql_fetch_array($result);
  $x=$row['categoria_id'];
  $sub=$row['subcategoria_nombre'];
}
...
?>
  ...
  <p>
    <label>* Categor&iacute;a:
      ...
      <select name="categoria_nombre" id="categoria_nombre" class="ancho">
			  ...
			  if($num_rows>0)
			   {
				   while($row2=mysql_fetch_array($result2))
				    {
	   ?>
        <option value="<?php echo $row2['categoria_id']?>" <?php if($x==$row2['categoria_id']){ echo 'selected="selected"';}  ?> ><?php echo strtoupper($row2['categoria_nombre']) ?></option>
 ...
 <p>
    <label>* Subcategoria:
      <input type="text" class="ancho" name="subgategoria_nombre" id="subgategoria_nombre" value="<?php echo strtoupper($sub)  ?>" />
    </label>
