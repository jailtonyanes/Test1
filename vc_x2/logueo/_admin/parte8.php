...
<p align="center" style="font-size:16"><strong>Informaci&oacute;n que recibo de la empresa acerca de mis funciones</strong></p>
...
<input type="hidden" name="docu" id="docu" />
  <table width="800" border="0" id="datos_cli" cellpadding="0" cellspacing="0" style="margin:5px auto">
    <?php
			  $query="SELECT * FROM preguntas WHERE encuesta_id =1 AND pertenece_a = 'INYO'";
