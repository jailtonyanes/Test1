...
<h2><?php echo 'Gracias por su tiempo.' ?> <a href="clientes.php" style="text-decoration:none;cursor:pointer; font-size:22px" >&nbsp;&nbsp; Inicio</a></h2>
<?php 
   }
   else
    {
...
<p align="center" style="font-size:16"><strong>Condiciones Ambientales</strong></p>
...
<input type="hidden" name="docu" id="docu" />
  <table width="800" border="0" id="datos_cli" cellpadding="0" cellspacing="0" style="margin:5px auto">
    <?php
			  $query="SELECT * FROM preguntas WHERE encuesta_id =1 AND pertenece_a = 'CAMB'";
